...
public class Token {
    ...
    public static final Token alertTextTok = new Token(TokenType.AlertText, "alert");
    public static final Token eofTok = new Token(TokenType.Eof, "<<EOF>>");
    public static final Token ml2jsTextTok = new Token(TokenType.Ml2jsText, "ml2js");
    public static final Token varTextTok = new Token(TokenType.VarText, "var");
    public static final Token typeTextTok = new Token(TokenType.TypeText, "type");
    public static final Token nameTextTok = new Token(TokenType.NameText, "name");
    public static final Token assignTextTok = new Token(TokenType.AssignText, "assign");
    public static final Token conditionTextTok = new Token(TokenType.ConditionText, "condition");
    public static final Token targetTextTok = new Token(TokenType.TargetText, "target");
